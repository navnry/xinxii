...
.cont{margin-top: 24rpx; display: flex; padding-right: 24rpx; position: relative;height: calc(100vh - 212rpx);
    ...
    .tab-list{flex-shrink: 0; width: 160rpx; height: 100%; margin-right: 24rpx; background-color: #fff; text-align: center;
    ...
    .cont-list{flex-grow: 1; height: 100%; border-radius: 10rpx 10rpx 0 0; background-color: #fff; padding: 24rpx 0 24rpx 24rpx;
