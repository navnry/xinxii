	...
	<view class="content">
		...
		<view class="info">
			<view class="info-box">
				...
				<x-list-item title="被保人出生日期" tips="注：30天（含）-70周岁（含）" height="auto">
				...
				<x-radio-box ref="ion" @change="setIon"></x-radio-box>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		onLoad(option) {
			this.insuredStartDate = setLimitTime(70,'start') //被保人最大年龄限制
			...
			judgePlanCode(){/*计划类型*/
				switch (this.planArr.toString()) {
					...
					case [0, 0, 0].toString():
						...
						break;
					case [1, 1, 0].toString():
						this.sendData.planCode = 'JJDAFA(SI)(T)'
						break;
					case [0, 1, 0].toString():
				...
				console.log(this.sendData.planCode)
			},
