<template>
	<view class="content">
        ...
        <view class="pop" v-show="isShow">
            <view class="top">
                <image lazy-load src="../../static/sign_pop_head.png" mode=""></image>
                <view class="txt-box">
                    <view class="tit">恭喜你获得一份日签</view>
                    <view class="tip">每一份日签代表一份美好生活的开始</view>
                </view>
            </view>
            <image lazy-load class="success" src="../../static/sign_success.png" mode=""></image>
            ...
            <view class="time-box">
                <view class="item" :class="{act : current === index}" v-for="(item,index) in signData" :key="index" @click="seeDay(item,index)">
                    <view :class="{newDay : item.newDay == 1}">
                        ...
                        <image lazy-load class="start" v-if="item.status == 1" :src="current ===index ? '../../static/sign/sign_start.png':'../../static/sign/sign_start_act.png'" mode=""></image>
                        <image lazy-load v-else :src=" current ===index ?'../../static/sign/sign_no_act.png':'../../static/sign/sign_no.png'" mode=""></image>
                    </view>
                </view>
            </view>
        </view>
