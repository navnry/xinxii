...
.img{width: 100%; font-size: 0;position: relative;
	...
	.rule{position: fixed; top: calc(136rpx + var(--status-bar-height));right: 0;width: 172rpx;height: 64rpx;background: rgba(255,255,255,.74);border-radius: 200rpx 0 0 200rpx;padding: 12rpx 0;box-sizing: border-box;text-align: center;font-size: 28rpx;color: #FF5000;line-height: 40rpx;}
