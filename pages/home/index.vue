        	...
        	<view class="top-banner" v-if="topBannerList.length > 0">
        		<swiper class="home-swiper" circular = "true" :interval="topBannerList[0].playSecond*1000" indicator-dots="true" :autoplay="true" indicator-active-color="#DD5501" indicator-color="#fff">
        			<swiper-item v-for="(item,index) in topBannerList" :key="index" @click="openUrl(item.link)">
        				<view class="swiper-item"><image lazy-load :src="item.pic || '../../static/banner_defalut.png'" mode="aspectFill"></image></view>
        			</swiper-item>
        		</swiper>
        	</view>
           <!-- <view style="height: 60rpx; background-color: greenyellow; text-align: center; line-height: 60rpx;" @click="payTest(1)">刷单入口</view>
            <view style="height: 60rpx; background-color: greenyellow; text-align: center; line-height: 60rpx; margin-top: 30rpx;" @click="payTest(2)">APP支付入口</view> -->
            <!-- <view style="height: 60rpx; background-color: greenyellow; text-align: center; line-height: 60rpx; margin-top: 30rpx;" @click="payTest(3)">小程序支付入口</view>
            <view style="height: 60rpx; background-color: greenyellow; text-align: center; line-height: 60rpx; margin-top: 30rpx;" @click="openUrl('./webView')">webView</view> -->
        	<view class="article">
        	    <swiper class="swiper" circular = "true" :autoplay="true" :vertical="true">
        	        <swiper-item v-for="item in informList" :key="item.id">
        	            <view class="swiper-item">
                            <image lazy-load src="../../static/index_article.png" mode=""></image>
        	...
        	<view class="start-product" @click="goStarProduct">
        	    <view class="tit-box">
                    <view class="left">
                        <image lazy-load src="../../static/index_start.png" mode=""></image>
                        <text>集合全网热门产品</text>
                    </view>
                    <view class="right">
                        <text>GO</text>
                        <image lazy-load src="../../static/index_arrow_white.png" mode=""></image>
                    </view>
                </view>
                <view class="product-box">
                    <view class="product-item">
                        <view class="img-box">
                            <image lazy-load class="img" src="../../static/home_start_item1.png" mode="aspectFill"></image>
                        </view>
                    </view>
                    <view class="product-item">
                        <view class="img-box">
                            <image lazy-load class="img" src="../../static/home_start_item2.png" mode="aspectFill"></image>
                        </view>
                    </view>
                    <view class="product-item">
                        <view class="img-box">
                            <image lazy-load class="img" src="../../static/home_start_item3.png" mode="aspectFill"></image>
                        </view>
                    </view>
                </view>
        	</view>
            <view class="activty">
                ...
                <view class="activty-list">
                    <view class="activty-item" @click="openUrl('../join/homejoin')">
                        <image lazy-load src="../../static/index_active_item01.png" mode=""></image>
                    </view>
                    <view class="activty-item" @click="openUrl('./invitation')">
                        <image lazy-load src="../../static/index_active_item02.png" mode=""></image>
                    </view>
                </view>
            </view>
