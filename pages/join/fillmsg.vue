...
.content{padding: 0 24rpx;
    .top{
        .flow{display: flex; padding: 24rpx 32rpx; justify-content: space-between;
            .flow-item{
                ...
                &.act{
                    .num{border-color: #FF5000; background: #FFD2BD; color: #FF5000;}
                    .txt{color: #ff5000;}
                }
                &:last-of-type{
                    .num{
    ...
    .btn{ border-radius: 8rpx; width: 702rpx; height: 88rpx; line-height: 88rpx; font-size: 32rpx; color: #fff; font-weight: bold; background-color: #ff5000;}
}  
</style>
