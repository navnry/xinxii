  ...
  <view class="binding">
    ...
    <view class="box">
        <view class="group">
          <view class="item">
            <view class="left">
              <image lazy-load class="phone-img" src="../../static/h5register/register_phone.png" alt=""></image>
            </view>
            <input v-model="sendData.phone" type="text" placeholder="手机号">
          </view>
          <view class="item">
            <view class="left">
              <image lazy-load class="code-img" src="../../static/h5register/register_code.png" alt=""> </image>
            </view>
...
<style lang="less" scoped>
	.binding{width: 100%; background: url('../../static/h5register/register_bg.png') no-repeat; background-size: 100% 100%; font-size: 32rpx; position: absolute; min-height: 100%;}
    .box{
