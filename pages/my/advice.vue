    ...
    <view class="content">
        ...
        <view class="img-box">
            <view class="img-item" v-for="(item,index) in picList" :key="index">
				<image class="img-item-del" lazy-loadd src="../../static/upimg-del.png" @click="removeImage(index)"></image>
    ...
    .img-box{font-size: 0; display: flex; flex-wrap: wrap;
		.img-item{position: relative;
			image{width: 200rpx; height: 200rpx; margin-right: 20rpx; margin-bottom: 24rpx;
				&.img-item-del{width: 36rpx;height: 36rpx;position: absolute;top:-18rpx;right: -18rpx;z-index: 10;}
			}
		}
