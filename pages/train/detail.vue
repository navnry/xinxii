<template>
    <view class="content">
        ...
        <b-share-wechat :url="url" :title="articleData.title" :articleId="id" :imageUrl="articleData.pic+'?imageMogr2/thumbnail/200x200'" :summary="articleData.subTitle" typeNumber=0 :show="show" @click="hideModal"></b-share-wechat>
