        ...
        <view class="main">
            ...
            <view v-if="configinfo.value === 'true'">
                ...
                <button class="weixin-btn" @tap="toOauth">
                    <image lazy-load src="../../static/login_wechat.png" mode=""></image>
                </button>
                <view class="platform">微信</view>
            </view>
        </view>
		<view class="tips">登录即代表已同意<text @click.stop="openUrl('../ebook/register')">用户注册及使用协议、</text><text @click.stop="openUrl('../ebook/privacypolicy')">隐私政策</text>及<text @click.stop="openUrl('../ebook/personal')">个人信息使用授权书</text></view>
    </view>
</template>
...
.content{position: absolute; width: 100%; min-height: 100vh; background-color: #FFF; padding-bottom: 40rpx;
    .main{ position: relative; z-index: 1; background-color: #fff; padding: 48rpx 72rpx 0;
        ...
        .cont{
            ...
            .login-btn{ height: 88rpx; line-height: 88rpx; background-color: #FF5000; border-radius: 4rpx; color: #fff; font-size: 32rpx; margin: 48rpx 0 24rpx;}
        ...
        .weixin-btn{ height: 108rpx; width: 108rpx; border-radius: 50%; margin: 48rpx auto 0; font-size: 0; background-color: #fff;
            image{width: 108rpx; height: 108rpx;}
        }
        .platform{text-align: center; font-size: 24rpx; color: #999; line-height: 34rpx;}
        // .register{text-align: center; font-size: 28rpx; margin-top: 52rpx;
        //     >text{color: #999;}
        //     .btn-txt{display: inline-block;}
        // }
        // .btn-txt{color: #21C38F; font-size: 28rpx;}
    }
