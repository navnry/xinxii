<template>
    <view class="content">
        ...
        <view class="img">
            <image lazy-load class="one" src="../../static/home_training_bg_01.jpg" mode=""></image>
            ...
            <image lazy-load src="../../static/home_training_bg_02.jpg" mode=""></image>
            <view class="banner2">
            	<swiper class="home-swiper"  indicator-dots="true" :autoplay="true" indicator-active-color="#2e098a" indicator-color="#fff">
            ...
            <image lazy-load src="../../static/home_training_bg_03.jpg" mode=""></image>
