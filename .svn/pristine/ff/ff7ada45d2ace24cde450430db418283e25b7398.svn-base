        ...
        .box{ background: #fff; margin: 0 auto; width: 702rpx; padding: 24rpx;
            .detail{ display: flex;
                ...
                .info{flex-grow: 1; border-bottom: 1px solid #F0F0F0;
                    ...
                    .name{font-size: 32rpx; line-height: 44rpx; .text-line(1);}
                    .txt{font-size: 28rpx; color: #999; line-height: 40rpx; margin: 12rpx 0 24rpx; .text-line(1);}
                }
            }
            .product{background: #fff; padding-left: 124rpx; display: flex; justify-content: space-between; align-items: flex-end;
                .info{flex-grow: 1;
                    .name{font-size: 32rpx; font-weight: bold; line-height: 44rpx; .text-line(1); margin: 22rpx 0 12rpx;}
