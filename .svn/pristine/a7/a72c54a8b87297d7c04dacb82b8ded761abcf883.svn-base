...
<style lang="less" scoped>
    ...
    .btn{width: 702rpx; height: 88rpx; line-height: 88rpx; border-radius: 8rpx; color: #fff; background-color: #ff5000; margin: 72rpx auto 0; font-size: 32rpx;}
</style>
