	...
	<view class="content">
		<x-nav-bar leftWidth="24rpx" rightWidth="24rpx" :noBorder="true" leftIcon="none" title=" ">
		    <view class="head" @click="call">
		        <image lazy-load src="../../static/service.png" mode="aspectFill"></image>
		    </view>
		</x-nav-bar>
        ...
        <view class="top-info">
            <view class="top" @click="toUserInfo">
                ...
                <image lazy-load class="arrow-img" src="../../static/arrow_right1.png" mode=""></image>
            </view>
        ...
        <view class="wallet" v-if="!isLogin" @click="toWallet">
            <view class="tit">
                ...
                <view class="wallet-img">
                    <image lazy-load @click.stop="isShow = !isShow" :src="isShow ? '../../static/my_money_eye.png':'../../static/my_money_eye1.png'" mode=""></image>
                </view>
            </view>
            <view class="list">
       ...
       <view class="wallet" v-else-if="isLogin && assetsData" @click="openUrl('../assets/index')">
        ...
        <view class="group-order" v-if="userinfo.isExpert==1">
            <view>
                <image lazy-load class="img1" src="../../static/order_end.png" mode=""></image>
                <view class="txt">一大波钱正在朝你赶来</view>
            </view>
            <image lazy-load class="img2" src="../../static/order_end_img.png" mode=""></image>
        </view>
        <view class="group-order" v-else>
            <view>
                <image lazy-load class="img1" src="../../static/order_no.png" mode=""></image>
                <view class="txt">开单奖励在等你哦！</view>
            </view>
            <image lazy-load class="img2" src="../../static/order_no_img.png" mode=""></image>
        </view>
        <view class="group-list">
            <x-list-item title="订单列表" height="94rpx" @click="toOrder">
                <image lazy-load class="left-img" slot="left" src="../../static/center_item1.png" mode=""></image>
                <view v-if="isLogin&&assetsData" class="money" slot="right">待结算保费 ¥{{isShow?(assetsData.settlementRevenue>0?assetsData.settlementRevenue.toFixed(2):'0.00'):'****'}}</view>
                <view v-else class="money" slot="right">待结算保费 ¥****</view>
            </x-list-item>
            <x-list-item title="客户管理" height="94rpx" @click="toCustomer">
                <image lazy-load class="left-img" slot="left" src="../../static/center_item2.png" mode=""></image>
            </x-list-item>
            <x-list-item title="我的邀请" height="94rpx" @click="toInvite">
                <image lazy-load class="left-img" slot="left" src="../../static/center_item3.png" mode=""></image>
            </x-list-item>
            <x-list-item title="平台资质" height="94rpx" @click="openUrl('./platinfo')">
                <image lazy-load class="left-img" slot="left" src="../../static/center_item4.png" mode=""></image>
            </x-list-item>
            <x-list-item title="账户设置" height="94rpx" @click="openUrl('./set')" border="0">
                <image lazy-load class="left-img last" slot="left" src="../../static/center_item5.png" mode=""></image>
            </x-list-item>
        </view>
        <view class="feedback" @click="toAdvice">
            <image lazy-load src="../../static/my_feedback.png" mode=""></image>
        </view>
