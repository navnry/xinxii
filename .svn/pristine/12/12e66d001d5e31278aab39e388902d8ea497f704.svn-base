		...
		:duration="duration">
			<swiper-item>
				<view class="swiper-item">
					<view class="swiper-item-img swiper-item-img1"><image lazy-load src="../../static/guide/icon_01.png" mode="aspectFit"></image></view>
					<view class="swiper-item-img swiper-item-img2"><image lazy-load src="../../static/guide/title_01.png" mode="aspectFit"></image></view>
				</view>
				<view class="jump-over" @click="launchFlag()">{{jumpover}}</view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-item">
					<view class="swiper-item-img swiper-item-img1"><image lazy-load src="../../static/guide/icon_02.png" mode="aspectFit"></image></view>
					<view class="swiper-item-img swiper-item-img2"><image lazy-load src="../../static/guide/title_02.png" mode="aspectFit"></image></view>
				</view>
				<view class="jump-over" @click="launchFlag()">{{jumpover}}</view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-item">
					<view class="swiper-item-img swiper-item-img1"><image lazy-load src="../../static/guide/icon_03.png" mode="aspectFit"></image></view>
					<view class="swiper-item-img swiper-item-img2"><image lazy-load src="../../static/guide/title_03.png" mode="aspectFit"></image></view>
				</view>
				<view class="experience" @click="launchFlag()">{{experience}}</view>
			</swiper-item>
		</swiper>
		<view class="uniapp-img"><image lazy-load src="../../static/guide/welcome-logo.png" mode="aspectFit"></image></view>
	</view>
</template>
